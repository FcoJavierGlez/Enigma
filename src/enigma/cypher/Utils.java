...
public class Utils {
  ...
  public static boolean esCapicua (int numeroEntrada) {
    ...
    return cadena.equals( voltea(numeroEntrada) );
  }
    ...
    if (esHexa(cadena)) {
      for (int i = 0; i < longitud; i++) {
        if (cadena.substring(i, i + 1).equalsIgnoreCase("A")) {
          digito=10;
        } else if (cadena.substring(i, i + 1).equalsIgnoreCase("B")) {
          digito=11;
        } else if (cadena.substring(i, i + 1).equalsIgnoreCase("C")) {
          digito=12;
        } else if(cadena.substring(i, i + 1).equalsIgnoreCase("D")) {
          digito=13;
        } else if (cadena.substring(i, i + 1).equalsIgnoreCase("E")) {
          digito=14;
        } else if (cadena.substring(i, i + 1).equalsIgnoreCase("F")) {
          digito=15;
        } else {
